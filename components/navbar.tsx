...
const Navbar = () => {
  return (
         <nav className="bg-[#0A0A0A] border border-[#1A1A1A] h-[40px] flex items-center">
       <div className="w-full">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <button 
              className="bg-[#0050FF] hover:bg-[#0040CC] text-white text-sm font-medium px-6 h-[42px] transition-colors duration-200"
            >
              Login
            </button>
          </div>
